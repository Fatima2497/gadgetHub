...
const SingleProduct = () => {
  ...
  const props = {
    ...
    height: 600,
    zoomWidth: 600,
    img: productState?.images[0]?.secure_url,
  };
  ...
  const addRatingToProduct = () => {
    if (star === null) {
      ...
      dispatch(
        rateProd({ star: star, comment: comment, prodId: getproductId })
      );
      setTimeout(() => {
        dispatch(getProduct(getproductId));
      }, 100);
                ...
                <ReactImageMagnify
                  {...{
                    smallImage: {
                      ...
                      isFluidWidth: true,
                      src: productState?.images[0]?.secure_url,
                    },
                    largeImage: {
                      src: productState?.images[0]?.secure_url,
                      width: 1200,
                ...
                <div className="py-3">
                  ...
                  <div className="d-flex gap-10 flex-column mt-2 mb-3">
                    ...
                    <div className="d-flex gap-15 flex-wrap">
                      <span className="badge border text-dark border-1 border-secondary bg-white">
                        S
                      </span>
                      <span className="badge border text-dark border-1 border-secondary bg-white">
                        L
                  ...
                  <div className="d-flex gap-15 align-items-center flex-row mt-2 mb-3">
                    ...
                    <div
                      className={
                        alreadycart
                          ? "ms-0"
                          : "ms-5" + "d-flex align-items-center ms-5 gap-10"
                      }
                    >
                      <button
                        ...
                        type="submit"
                        onClick={() =>
                          alreadycart ? navigate("/cart") : uploadCart()
                        }
                      >
                        {alreadycart ? "Go to Cart" : "Add To Cart"}
                      </button>
                    </div>
                  </div>
